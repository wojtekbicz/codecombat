...
#    setup_a_class: "Set Up a Class"
    ...
    coming_soon: "Wkrótce!"
    courses_available_in: "Kursy dostępne są w języku JavaScript, Python, oraz Java (wkrótce!)" # {change}
...
#    premium: "Premium" # Make sure the following feature translations don't go onto two lines
    ...
    feature4: "<strong>{{gems}} klejnotów</strong> co miesiąc!" # {change}
...
#    liz_title: "Territory Manager"
    ...
    community_subtitle: "Ponad 450 kontrybutorów pomogło stworzyć CodeCombat i liczba ta cały czas rośnie!" # {change}
...
#    xy_coordinates: "Cartesian Coordinates"
    advanced_strings: "Zaawansowane napisy" # Rest of concepts are deprecated
